/* filename: MaintenanceRequestCompletionReport.java 
 * date: April 6th, 2025
...
/**
 * This class models a servlet to display maintenance requests by their completion status.
 * 
 * @author Mathew Chebet
 * @version 1.0
 * @since 21
 */
@WebServlet(name = "MaintenanceRequestCompletionReport", urlPatterns =
{
    "/MaintenanceRequestCompletionReport"
})
public class MaintenanceRequestCompletionReport extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        try (PrintWriter out = response.getWriter())
        {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MaintenanceRequestCompletionReport</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MaintenanceRequestCompletionReport at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            throws ServletException, IOException
    {
        ...
        try (PrintWriter out = response.getWriter())
        {
            try{
                ...
                List<Object[]> resultSet = logic.getMaintenanceRequestsByCompletion();
                ...
                if(resultSet != null){ 
                    ...
                    out.println("<body>");
                    out.println("<center>");
                    out.println("<h1>Maintencance Request Report By Completion</h1>");
                    out.println("<table>");
