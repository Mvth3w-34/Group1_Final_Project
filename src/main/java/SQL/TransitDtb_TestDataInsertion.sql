...
VALUES
	("BUS", "001", "DEISEL", 10.0, 75, NULL), 
    ("BUS", "002", "CNG", 9.0, 60, NULL),
    ("ELECTRIC TRAIN", "T100", "ELECTRICITY", 1000.0, 300, NULL), 
    ("DEISEL TRAIN", "T200", "DEISEL", 30.0, 240, NULL)
    ;
...
-- still need actual values for punch times and operator_id?
/*
...
INSERT INTO COMPONENT_TYPE(COMPONENT_NAME) 
VALUES 
	('REAR BRAKES'),
	('FRONT BRAKES'),
	('LEFT REAR TIRE'),
...
INSERT INTO VEHICLE_COMPONENT (HOURS_USED, VEHICLE_ID, COMPONENT_ID) 
VALUES 
	(600, 1, 1),
	(600, 1, 2),
	(2000, 1, 3),
...
INSERT INTO MAINTENANCE_REQUEST (REQUEST_DATE, QUOTED_COST, OPERATOR_ID, VEHICLE_COMPONENT_ID, SERVICE_DESCRIPTION, IS_COMPLETED) 
-- updated inserts: boolean values for is_completed, and nullS (for now) for optional operator_id. original below
VALUES 
	('2025-12-03', 300.50, NULL, 1, 'BRAKE REPLACEMENT', FALSE),
	('2025-12-05', 300.50, NULL, 2, 'BRAKE REPLACEMENT', FALSE),
	('2023-10-03', 600, NULL, 13, 'CIRCUIT BREAKER REPLACEMENT', TRUE),
	('2022-12-03', 300.50, NULL, 10, 'BRAKE REPLACEMENT', TRUE),
	('2022-12-04', 300.50, NULL, 11, 'BRAKE REPLACEMENT', TRUE),
	('2022-09-03', 1500.50, NULL, 21, 'ENGINE REPLACEMENT', TRUE),
	('2022-07-03', 300.50, NULL, 7, 'AXLE BEARING REPLACEMENT', TRUE),
	('2021-12-05', 300.50, NULL, 8, 'AXLE BEARING REPLACEMENT', TRUE),
	('2021-11-06', 105.50, NULL, 3, 'TIRE REPLACEMENT', TRUE),
	('2021-10-15', 105.50, NULL, 4, 'TIRE REPLACEMENT', TRUE),
	('2021-12-30', 300.50, NULL, 11, 'BRAKE REPLACEMENT', TRUE),
	('2021-03-03', 2000.20, NULL, 15, 'ENGINE REPLACEMENT', TRUE),
	('2020-01-15', 700.50, NULL, 12, 'CATERNARY REPLACEMENT', TRUE),
	('2020-12-16', 500.20, NULL, 14, 'PANTOGRAPH REPLACEMENT', TRUE)
    ;
/* Data that uses varchar 'YES' or 'NO' for IS_COMPLETED 
-- still need actual values for operator_id values?
	('2025-12-03', 300.50, OPERATOR_ID, 1, 'BRAKE REPLACEMENT', 'NO'),
	('2025-12-05', 300.50, OPERATOR_ID, 2, 'BRAKE REPLACEMENT', 'NO'),
	('2023-10-03', 600, OPERATOR_ID, 13, 'CIRCUIT BREAKER REPLACEMENT', 'YES'),
	('2022-12-03', 300.50, OPERATOR_ID, 10, 'BRAKE REPLACEMENT', 'YES'),
	('2022-12-04', 300.50, OPERATOR_ID, 11, 'BRAKE REPLACEMENT', 'YES'),
	('2022-09-03', 1500.50, OPERATOR_ID, 21, 'ENGINE REPLACEMENT', 'YES'),
	('2022-07-03', 300.50, OPERATOR_ID, 7, 'AXLE BEARING REPLACEMENT', 'YES'),
	('2021-12-05', 300.50, OPERATOR_ID, 8, 'AXLE BEARING REPLACEMENT', 'YES'),
	('2021-11-06', 105.50, OPERATOR_ID, 3, 'TIRE REPLACEMENT', 'YES'),
	('2021-10-15', 105.50, OPERATOR_ID, 4, 'TIRE REPLACEMENT', 'YES'),
	('2021-12-30', 300.50, OPERATOR_ID, 11, 'BRAKE REPLACEMENT', 'YES'),
	('2021-03-03', 2000.20, OPERATOR_ID, 15, 'ENGINE REPLACEMENT', 'YES'),
	('2020-01-15', 700.50, OPERATOR_ID, 12, 'CATERNARY REPLACEMENT', 'YES'),
	('2020-12-16', 500.20, OPERATOR_ID, 14, 'PANTOGRAPH REPLACEMENT', 'YES')
    ;
*/
